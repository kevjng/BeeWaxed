      ...
      <div className="container my-20 md:px-8 bg-slate-00 rounded-3xl">
        <div className="p-8 rounded-md justify-center text-center">
          <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-400">Bienvenido a nuestro sitio web. En "Nosotros", nos apasiona ofrecer las mejores plantas para tu hogar. Con una amplia variedad de opciones, desde plantas luminosas hasta plantas vintage, estamos seguros de que encontrarás la planta perfecta para dar vida a tu espacio.</p>
